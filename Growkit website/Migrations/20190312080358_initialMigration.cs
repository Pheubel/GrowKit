    ...
    public partial class initialMigration : Migration
    {
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    table.PrimaryKey("PK_FriendRelations", x => x.RelationId);
                    table.ForeignKey(
                        name: "FK_FriendRelations_AspNetUsers_RequestRecieverId",
                        column: x => x.RequestRecieverId,
                        principalTable: "AspNetUsers",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.Cascade);
                    table.ForeignKey(
                        name: "FK_FriendRelations_AspNetUsers_RequestSenderId",
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    table.PrimaryKey("PK_Hubs", x => x.IMSI);
                    table.ForeignKey(
                        name: "FK_Hubs_AspNetUsers_ApplicationUserId",
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    table.PrimaryKey("PK_SensorSticks", x => x.SensorId);
                    table.ForeignKey(
                        name: "FK_SensorSticks_Hubs_ConnectedHubIMSI",
                        column: x => x.ConnectedHubIMSI,
                        principalTable: "Hubs",
            ...
            migrationBuilder.CreateIndex(
                name: "IX_FriendRelations_RequestRecieverId",
                table: "FriendRelations",
                column: "RequestRecieverId");

            migrationBuilder.CreateIndex(
                name: "IX_FriendRelations_RequestSenderId",
                table: "FriendRelations",
                column: "RequestSenderId");

            migrationBuilder.CreateIndex(
                name: "IX_Hubs_ApplicationUserId",
                table: "Hubs",
                column: "ApplicationUserId");

            migrationBuilder.CreateIndex(
                name: "IX_SensorSticks_ConnectedHubIMSI",
                table: "SensorSticks",
                column: "ConnectedHubIMSI");
        }
