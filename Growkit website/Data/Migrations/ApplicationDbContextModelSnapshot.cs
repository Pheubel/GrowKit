...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("GrowkitDataModels.Friends", b =>
                {
                    ...
                    b.Property<Guid?>("FriendFromId");

                    b.Property<Guid?>("FriendToId");
            ...
            modelBuilder.Entity("GrowkitDataModels.GKSensorStick", b =>
                {
                    ...
                    b.Property<decimal?>("ConnectedHubIMSI")
                        .HasConversion(new ValueConverter<decimal, decimal>(v => default(decimal), v => default(decimal), new ConverterMappingHints(precision: 20, scale: 0)));
            ...
            modelBuilder.Entity("GrowkitDataModels.Friends", b =>
                {
                    b.HasOne("GrowkitDataModels.ApplicationUser", "FriendFrom")
                        .WithMany()
                        .HasForeignKey("FriendFromId");

                    b.HasOne("GrowkitDataModels.ApplicationUser", "FriendTo")
                        .WithMany()
